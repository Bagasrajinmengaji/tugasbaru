                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="header_hero_content mt-45">
                            ...
                            <ul>
                                <a href="http://localhost/tugasbaru/login.php" rel="nofollow" class="main-btn main-btn-2 wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.4s">Login</a>
                            </ul>
